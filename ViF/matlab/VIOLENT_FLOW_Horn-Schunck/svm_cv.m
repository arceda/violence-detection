...
data_fights     = csvread('VIF-HornSchunk_peliculas_fight_100(SS-3)_GAUSS.csv');  %100 X 40
data_nofights   = csvread('VIF-HornSchunk_peliculas_no_fight_100(SS-3)_GAUSS.csv');  %100 X 40
